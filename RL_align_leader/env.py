...
class RLAlignLeader(ParallelEnv):
    ...
    def __init__(self, leader_uav: Leader, num_agents: int = 5, render_mode=None, log_csv=False):
        ...
        # Entity observation vector: [local_x, local_y, sin_diff, cos_diff, is_leader, is_follower]
    ...
    def _init_csv_file(self, folder="metrics", prefix="metrics_align_leader_", ext=".csv") -> str:
    ...
    def step(self, actions):
        ...
        N = len(all_pos)
        centroid = np.mean(all_pos, axis=0)  # Fixed axis reduction bug
